 ...
 ** TEXT FORMAT
 **
 ** (thanks to David L�onard) -- Beta, but working. -- broken pending existence of acessBD.php
 ...
 ********************************************************************************/
		case "text":  // Deprecrated
		    ...
		    echo "NUMERO\tPRENOM\tNOM\tTITRE\tANNIVERSAIRE\tM�J LE\tPROPRIETAIRE\tTYPE ADRESSE\tADRESSE1\tADRESSE2\tVILLE\tETAT\tNPA\tPAYS\tTEL1\tTEL2\t";
		    ...
		    //remplissage des donn�es suivant les entetes
		    foreach ($data->row as $donnee) {
		    	if ($donnee == NULL) break;
		    	//s�lection du nom du pays
		    	...
		    	//affichage des donn�es communes
		    	...
		    	//s�lection des des groupes dont fait partie l'adresse courante
